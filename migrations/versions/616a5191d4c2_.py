...
Revision ID: 616a5191d4c2
Revises: 2277929b53ae
Create Date: 2020-11-26 19:38:48.026891
...
revision = '616a5191d4c2'
down_revision = '2277929b53ae'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['product_id'], ['w3_db.Products.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['sale_id'], ['w3_db.Sales.id'], ondelete='CASCADE'),
